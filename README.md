...
**[Balance Sheet]** is aimed to teach you how to apply CSS selectors and pseudo-selectors in your projects.
...
- https://cuauh-cabrera.github.io/balance-sheet/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/balance-sheet.git
```
